  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="text text-right leading-9 flex flex-col justify-center md:flex md:flex-col md:justify-center md:tex">
        <span className=" font-bold text-4xl">:TFC تعريف</span>
        <p className="ta3rif">
        ...
        <span className="font-bold text-4xl">:مهمتنا</span>
        <p className="mohima">
        ...
        <span className="font-bold text-4xl">:القواعد والقيم</span>
        <p className="gawa3id">
        ...
        <span className="font-bold text-4xl">:تقييم الأداء</span>
        <p className="adaa">
        ...
        <span className="font-bold text-4xl">:الفرص المقدمة</span>
